...
namespace Desk.Aesthetics.PinnedImages.Data.Display
{
    public class PinnedImageData
    {
        ...
        public PinnedImageData(Guid id, string imageDirectory, double frameThickness, double rotationAngle, double locationX, double locationY, double width, double height, string captionText, bool isCaptionDisplayed, double shadowOpacity, double shadowDepth, double shadowDirection, double shadowBlurRadius, bool isShadowHidden)
        {
            Id = id;
